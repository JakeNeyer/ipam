(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.SocialIcons = factory());
	 ...
	 */
	// source: https://github.com/jaketrent/react-social-icons/blob/master/src/_networks-db.js
	const EMAIL_ICON = {
	...
	/* src/SocialIcons.svelte generated by Svelte v4.2.17 */
	...
	function create_fragment(ctx) {
		...
		return {
			c() {
				...
				attr(circle, "cy", "32");
				attr(circle, "r", "31");
				attr(g0, "class", "social-svg-background");
				attr(g0, "style", /*socialSvgBackgroundStyle*/ ctx[7]);
				attr(path0, "d", /*icon*/ ctx[4]);
				attr(g1, "class", "social-svg-icon");
				attr(g1, "fill", /*fgColor*/ ctx[1]);
				attr(path1, "d", /*mask*/ ctx[5]);
				attr(g2, "class", "social-svg-mask");
				attr(g2, "fill", /*bgColor*/ ctx[0]);
				attr(g2, "style", socialSvgMaskStyle);
				attr(svg, "class", "social-svg");
				attr(svg, "viewBox", "0 0 64 64");
				attr(svg, "style", socialSvgStyle);
				attr(div, "class", "social-container");
				attr(div, "style", socialContainerStyle);
				attr(span, "class", "social-icon");
				attr(span, "style", /*socialIconStyle*/ ctx[6]);
				set_style(span, "width", `${/*width*/ ctx[3]}px`);
				set_style(span, "height", `${/*height*/ ctx[2]}px`);
			},
			m(target, anchor) {
	...
	const socialSvgStyle = 'border-radius: 50%; position: absolute; inset: 0; width: 100%; height: 100%; fill-rule: evenodd;';
	const socialSvgMaskStyle = "@media (prefers-reduced-motion: no-preference) { --ms-transition: 'fill 170ms ease-in-out'; -o-transition: 'fill 170ms ease-in-out'; --moz-transition: 'fill 170ms ease-in-out'; --webkit-transition: 'fill 170ms ease-in-out'; transition: 'fill 170ms ease-in-out';}";
	...
	class SocialIcons extends SvelteComponent {
		constructor(options) {
			super();
