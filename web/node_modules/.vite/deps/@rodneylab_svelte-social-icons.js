...
// node_modules/@rodneylab/svelte-social-icons/src/_networks-db.ts
var EMAIL_ICON = {
  icon: "M17,22v20h30V22H17z M41.1,25L32,32.1L22.9,25H41.1z M20,39V26.6l12,9.3l12-9.3V39H20z",
  mask: "M41.1,25H22.9l9.1,7.1L41.1,25z M44,26.6l-12,9.3l-12-9.3V39h24V26.6z M0,0v64h64V0H0z M47,42H17V22h30V42z",
  color: "#7f7f7f"
};
var networks_db_default = {
  bandsintown: {
...
// node_modules/@rodneylab/svelte-social-icons/src/SocialIcons.svelte
var file = "node_modules/@rodneylab/svelte-social-icons/src/SocialIcons.svelte";
function create_fragment(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      attr_dev(circle, "r", "31");
      add_location(circle, file, 40, 9, 1281);
      attr_dev(g0, "class", "social-svg-background");
      attr_dev(
        g0,
        "style",
        /*socialSvgBackgroundStyle*/
        ctx[7]
      );
      add_location(g0, file, 39, 6, 1206);
      attr_dev(
        path0,
        "d",
        /*icon*/
      ...
      add_location(path0, file, 43, 8, 1383);
      attr_dev(g1, "class", "social-svg-icon");
      attr_dev(
        g1,
        "fill",
        /*fgColor*/
      ...
      add_location(g1, file, 42, 6, 1332);
      attr_dev(
        path1,
        "d",
        /*mask*/
      ...
      add_location(path1, file, 45, 75, 1487);
      attr_dev(g2, "class", "social-svg-mask");
      attr_dev(
        g2,
        "fill",
        /*bgColor*/
      ...
      attr_dev(g2, "style", socialSvgMaskStyle);
      add_location(g2, file, 45, 6, 1418);
      attr_dev(svg, "class", "social-svg");
      attr_dev(svg, "viewBox", "0 0 64 64");
      attr_dev(svg, "style", socialSvgStyle);
      add_location(svg, file, 38, 4, 1132);
      attr_dev(div, "class", "social-container");
      attr_dev(div, "style", socialContainerStyle);
      add_location(div, file, 37, 2, 1068);
      attr_dev(span, "class", "social-icon");
      attr_dev(
        span,
        "style",
        /*socialIconStyle*/
      ...
      ctx[3]}px`);
      set_style(span, "height", `${/*height*/
      ctx[2]}px`);
      add_location(span, file, 31, 0, 950);
    },
...
var socialContainerStyle = "position: absolute; inset: 0; width: 100%; height: 100%;";
var socialSvgStyle = "border-radius: 50%; position: absolute; inset: 0; width: 100%; height: 100%; fill-rule: evenodd;";
var socialSvgMaskStyle = "@media (prefers-reduced-motion: no-preference) { --ms-transition: 'fill 170ms ease-in-out'; -o-transition: 'fill 170ms ease-in-out'; --moz-transition: 'fill 170ms ease-in-out'; --webkit-transition: 'fill 170ms ease-in-out'; transition: 'fill 170ms ease-in-out';}";
function instance($$self, $$props, $$invalidate) {
  let { $$slots: slots = {}, $$scope } = $$props;
  validate_slots("SocialIcons", slots, []);
  let { network } = $$props;
  const { color, icon, mask } = networks_db_default[network];
  let { bgColor = color } = $$props;
  let { fgColor = "transparent" } = $$props;
  let { height = 48 } = $$props;
  let { width = 48 } = $$props;
  let { style = "" } = $$props;
  ...
  $$self.$$.on_mount.push(function() {
    if (network === void 0 && !("network" in $$props || $$self.$$.bound[$$self.$$.props["network"]])) {
      console.warn("<SocialIcons> was created without expected prop 'network'");
    }
  });
  const writable_props = ["network", "bgColor", "fgColor", "height", "width", "style"];
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot") console.warn(`<SocialIcons> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("network" in $$props2) $$invalidate(8, network = $$props2.network);
    if ("bgColor" in $$props2) $$invalidate(0, bgColor = $$props2.bgColor);
    if ("fgColor" in $$props2) $$invalidate(1, fgColor = $$props2.fgColor);
...
var SocialIcons = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
  ...
  get network() {
    throw new Error("<SocialIcons>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
  set network(value) {
    throw new Error("<SocialIcons>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
  get bgColor() {
    throw new Error("<SocialIcons>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
...
// node_modules/@rodneylab/svelte-social-icons/src/index.js
var src_default = SocialIcons_default;
export {
  src_default as default
};
//# sourceMappingURL=@rodneylab_svelte-social-icons.js.map
